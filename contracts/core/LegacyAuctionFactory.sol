...
import {LegacyAuction} from "./LegacyAuction.sol";
import {Clonable} from "./utils/Clonable.sol";

/// @title AuctionFactory
/// @notice Deploy a new Auction.
contract LegacyAuctionFactory is Clonable {
    ...
    constructor() {
        // Deploy the original
        original = address(new LegacyAuction());
    }
    ...
    function _createNewAuction(
        ...
        LegacyAuction(_newAuction).initialize(
            _want,
            _receiver,
            _governance,
            _auctionLength,
