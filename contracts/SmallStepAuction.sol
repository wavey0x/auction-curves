...
/**
 *   @title SmallStepAuction
 *   @author yearn.fi (modified)
 *   @notice Dutch auction contract with very small 6-second decay steps for 36-hour auctions.
 */
contract SmallStepAuction is Governance2Step, ReentrancyGuard {
    ...
    // Small step constants (RAY precision: 1e27)
    uint256 internal constant PRICE_UPDATE_INTERVAL = 36; // 36 seconds
    // Option 2: 36-hour auction but SAME FINAL PRICE as the 24h auction
    // Per step (36s): (0.5^24)^(1/3600) = 0.5^(1/150)
    uint256 internal constant STEP_DECAY = 995389679103229139420708864;
    ...
    /**
     * @dev Small step price function with 36-second intervals, same final price as 24h auction.
