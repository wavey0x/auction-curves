...
const AuctionHouseDetails: React.FC = () => {
  ...
  const { data: sales } = useQuery({
    queryKey: ["auctionHouseSales", address],
    ...
    <div className="space-y-10">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <div className="flex items-center space-x-2">
              <button
                onClick={() => handleCopy(auctionHouse.address)}
                className="font-mono text-sm text-gray-400 hover:text-gray-200 flex items-center space-x-1 transition-colors"
              >
                <span>{formatAddress(auctionHouse.address, 12)}</span>
                {copiedAddresses.has(auctionHouse.address) ? (
              ...
              {chainInfo.explorer !== "#" && (
                <a
                  href={`${chainInfo.explorer}/address/${auctionHouse.address}`}
                  target="_blank"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatsCard
          ...
          value={auctionHouse.activity.total_participants}
          icon={Users}
        ...
        <StatsCard
          title="Total Rounds"
          value={auctionHouse.activity.total_rounds}
          icon={TrendingUp}
        ...
        <StatsCard
          title="Total Sales"
          value={auctionHouse.activity.total_sales}
          icon={TrendingDown}
          iconColor="text-primary-500"
        />
        ...
        <StatsCard
          title="Total Volume"
          value={formatUSD(auctionHouse.activity.total_volume)}
          icon={DollarSign}
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 justify-items-center">
            <div className="text-center">
              ...
              <Link
                to={`/round/${auctionHouse.address}/${currentRound.round_id}`}
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 justify-items-center">
          <div className="text-center">
            ...
            <div className="flex items-center justify-center space-x-1">
              ...
              <span className="font-medium text-sm">
                {(
                  (1 -
                    parseFloat(auctionHouse.parameters.step_decay_rate) /
                      1e27) *
                  100
                ).toFixed(2)}
                %
          ...
          <div className="text-center">
            ...
            <div className="flex items-center justify-center space-x-1">
              ...
              <span className="font-medium text-sm">
                {auctionHouse.parameters.price_update_interval}s
              </span>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="font-medium text-sm">
              {formatDuration(auctionHouse.parameters.auction_length)}
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="font-mono text-sm">
              {formatTokenAmount(auctionHouse.parameters.starting_price, 6, 6)}
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="text-gray-300 text-sm">
              {formatTimeAgo(
                new Date(auctionHouse.deployed_at).getTime() / 1000
              )}
            </div>
          </div>
          ...
          {auctionHouse.last_kicked && (
            <div className="text-center">
              ...
              <div className="text-gray-300 text-sm">
                {formatTimeAgo(
                  new Date(auctionHouse.last_kicked).getTime() / 1000
                )}
              </div>
            </div>
          )}
